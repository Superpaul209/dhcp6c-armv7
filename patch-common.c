...
+	uint32_t ifr6_prefixlen;
 ...
 #endif
@@ -101,23 +101,119 @@ int debug_thresh;
 int foreground;
 int debug_thresh;
...
+dhcp6_clear_listval(struct dhcp6_listval *lv)
 {
 	...
 	switch (lv->type) {
@@ -192,11 +284,8 @@ struct dhcp6_listval *
...
@@ -257,10 +346,8 @@ struct dhcp6_listval *
 }
...
+	    (int64_t)ntohl((uint32_t)(x & 0xffffffff)) << 32;
 ...
 #define ntohq(x) (x)
@@ -643,7 +722,7 @@ dhcp6_auth_replaycheck(method, prev, current)
 int
...
@@ -990,11 +1069,11 @@ get_duid(idfile, duid)
...
@@ -1088,12 +1167,12 @@ struct hwparms {
 #ifdef __sun__
 struct hwparms {
 	char *buf;
-	u_int16_t *hwtypep;
...
@@ -2144,10 +2238,10 @@ sprint_uint64(buf, buflen, i64)
